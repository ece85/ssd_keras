...
def change_model_input_shape(model, new_input_shape = (None, 1500,2048,3)):
    
    model._layers[0].batch_input_layer = new_input_shape
    print('model summary = ')
    model.summary()

    save_model(model,'tmp_model.h5')
    print('loading model')
    new_model = load_model('tmp_model.h5', custom_objects={'AnchorBoxes': AnchorBoxes,
...
# new_img_width = 2048
# new_img_height = 1500
# input_shape = (None, new_img_height,new_img_width,3)

# new_model = change_model_input_shape(model,input_shape )
# new_model.summary()
# sys.exit(1)
new_img_height = 1500
new_img_width = 2048
...
#Images
images_dir = '../data/datasets/training_data_412_414_enhanced/'
...
if load_images_in_mem_flag == False:
    train_data_path = 'dataset_HeavyMachine_412_414_enhanced_train.h5'
    val_data_path = 'dataset_HeavyMachine_412_414_enhanced_val.h5'
...
print('predictor sizes = ' , predictor_sizes)
...
#     elem = next(train_generator)
    ...
    # print('matched_anchors 1 ', elem[1].shape)
    # print('matched_anchors 2 ', elem[2].shape)
...
model_checkpoint = ModelCheckpoint(filepath='../data/checkpoints/ssd300_heavy_machine/ssd300_heavy_machine_412_414_enhanced_forReal_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
