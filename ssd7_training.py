# import sys
# sys.path.insert(0,'/home/linuxosprey/ow_keras_ssd/ssd_keras/models')
...
model_checkpoint = ModelCheckpoint(filepath='../data/checkpoints/ssd7_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
fig.savefig('loss_vs_val_loss.png')
...
fig_bbox_img = plt.figure(figsize=(20,12))
...
for box in y_pred_decoded[i]:
    ...
    fig_bbox_img.savefig('bbox_on_img_' + str(i) + '.png')